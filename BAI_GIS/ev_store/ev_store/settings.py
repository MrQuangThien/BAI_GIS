"""
Django settings for ev_store project.
...
# Lệnh này bảo Django đi tìm file .env để nạp dữ liệu bí mật vào
load_dotenv()
...
SECRET_KEY = 'django-insecure--4l*b^$43gv=m474q4_x23-izt4*#vfe=r8$&ea=n+087$xm&('
...
CSRF_TRUSTED_ORIGINS = [
    "https://unfashionably-undancing-cherelle.ngrok-free.dev"
]
     ...
     'DIRS': [BASE_DIR / 'templates'],
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.thong_bao_admin',
            ],
        },
    },
]

WSGI_APPLICATION = 'ev_store.wsgi.application'
